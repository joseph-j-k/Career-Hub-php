        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr align="center">
                    ...
                    <th style="text-align:center">Vaccencies</th>
			...
			<?php
                ...
                session_start();
				 ...
				 $l=0;
			 		 ...
			 		 $selQry = "select *, COALESCE(sum(j.job_vacancy),0) as job_vacancy from tbl_job j GROUP BY j.job_name";
					    ...
					    $rs = mysql_query($selQry);
                   		...
                   		while ($data = mysql_fetch_array($rs)) 
                     		...
                     		$i++;
				   			...
				   			$sel = "select * from tbl_application a inner join tbl_jobseeker j on j.jobseeker_id = a.jobseeker_id";
							
							$row = mysql_query($sel);
							$data1 = mysql_fetch_array($row);
				   
							
							if(isset($_POST["btn_search"]))
						{
							$sel = $sel." and job_post_date between '".$_POST["fdate"]."' and '".$_POST["tdate"]."'";
						}
			...
			?>
              <tr align="center">
                 ...
                 <td align="center"><?php  echo $data["job_name"]; ?></td>
                 <td align="center"><?php  echo  $data["job_vacancy"];?></td>
                <td align="center"><?php  echo  $data1["jobseeker_name"];?></td>
              </tr>
               <?php
				   }
			?>
