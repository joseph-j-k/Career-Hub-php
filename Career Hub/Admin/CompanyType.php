...
include("../Assest/Connection/Connection.php");
	...
	if(isset($_POST["btnsubmit"]))
		{
			$statename=$_POST["txtctype"];
			$insqry="insert into tbl_companytype(companytype_name) values ('$statename')";
			mysql_query($insqry);
		...
		if(isset($_GET["delID"]))
		{
			$delQry="delete from tbl_companytype where companytype_id='".$_GET["delID"]."'";
			mysql_query($delQry);
...
<form id="form1" name="form1" method="post" action="">
  <table width="200" border="1">
    <tr>
      ...
      <td><input type="text" name="txtctype" id="txtctype" required placeholder="Enter Company Type"/></td>
    </tr>
    <tr>
...
<table border="1" align="center">
	...
	<tr>
    	<td><?php echo $i ?></td>
         ...
         <td><?php echo $row ["companytype_name"] ?></td>
        <td><a href="CompanyType.php?delID=<?php echo $row["companytype_id"]?>">Delete</a></td>
    </tr>
    <?php
			}
	?>
